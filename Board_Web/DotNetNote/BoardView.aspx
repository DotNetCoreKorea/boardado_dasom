<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BoardView.aspx.cs" Inherits="Board_Web.DotNetNote.BoardView" %>
<%@ Register Src="~/DotNetNote/Control/BoardCommentControl.ascx" TagPrefix="uc1" TagName="BoardCommentControl" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="text-align:center;">
        ...
        <asp:HyperLink ID="lnkList" runat="server" CssClas="btn btn-default" NavigateUrl="BoardList.aspx">리스트</asp:HyperLink>
