<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BoardCommentDelete.aspx.cs" Inherits="Board_Web.DotNetNote.BoardCommentDelete" %>
    ...
    <table style="width:500px; margin-left:auto; margin-right:auto;" >
        <tr>
            <td colspan="2">
                ...
                <span style="font-size:12pt;">댓글삭제</span>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
