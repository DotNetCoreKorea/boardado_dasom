<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BoardEditorFormControl.ascx.cs" Inherits="Board_Web.DotNetNote.Control.BoardEditorFormControl" %>
<style>
...
<table style="width:600px; border-collapse:collapse; padding:5px; margin-left:auto; margin-right:auto;">
    <%
    if (!String.IsNullOrEmpty(Request.QueryString["Id"]) && FormType == Board_Web.DotNetNote.Models.BoardWriteFormType.Modify)
    {
    ...
    <tr>
        ...
        <td style="width:500px;">
            ...
            <asp:RequiredFieldValidator ID="valName" runat="server" ErrorMessage="이름을 작성해주세요" ControlToValidate="txtName" Display="None" SetFocusOnErro="true"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <asp:RegularExpressionValidator ID="valEmail" runat="server" ErrorMessage="메일의 형식이 올바르지 않습니다." ControlToValidate="txtEmail" Display="None" 
    ...
    <tr>
        ...
        <td>
            ...
            <span style="color:#aaaaaa; font-style:italic;">(Optional)</span>
            <asp:RegularExpressionValidator ID="valHomepage" runat="server" ErrorMessage="홈페이지를 정확히 작성해주세요" ControlToValidate="txtHomepage" Display="None" 
                ValidationExpression="http://([\w-]+\.)+[\w-]+(\[w\- .\?&amp;=]*)?" SetFocusOnError="true"></asp:RegularExpressionValidator>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtContent" TextMode="MultiLine" runat="server" Height="150px" Width="480px" CssClass="form-control" style="display:inline-block;"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:CheckBox ID="chkUpload" runat="server" CssClass="check-inline" Text="이 체크박스를 선택하면 업로드 화면이 나타납니다." AutoPostBack="true" OnCheckedChanged="chkUpload_CheckedChanged" />
            <span style="color:#aaaaaa;font-style:italic">(Optional)</span>
            <br />
            <asp:Panel ID="pnlFile" runat="server" Width="480px" Visible="false" Height="25px">
                ...
                <asp:Label ID="lblFileNamePrevious" Text="" runat="server"></asp:Label>
            </asp:Panel>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtPassword" runat="server" CssClass="form-control" style="display:inline-block;" MaxLength="20" Width="150px" TextMode="Password" EnableViewState="false"></asp:TextBox>
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtImageText" runat="server" CssClass="form-control" style="display:inline-block;" EnableViewState="false" MaxLength="20" Width="150px"></asp:TextBox>
                <span style="color:#aaaaaa;">(아래에 제시되는 보안코드를 입력하시오.)</span>
                <br />
                <asp:Image  ID="imageSecurityImageText" runat="server" ImageUrl="~/DotNetNote/ImageText.aspx"/>
